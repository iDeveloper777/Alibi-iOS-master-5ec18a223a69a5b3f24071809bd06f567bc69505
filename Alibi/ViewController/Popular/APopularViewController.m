...
#import "ALoadingCollectionViewCell.h"

@implementation APopularViewController
...
- (void)viewDidLoad {
    ...
    UINib *nib = [UINib nibWithNibName:@"APostCollectionViewCell" bundle:nil];
    [self.collectionViewPopular registerNib:nib forCellWithReuseIdentifier:@"APostCollectionViewCell"];
    [self.collectionViewRecent registerNib:nib forCellWithReuseIdentifier:@"APostCollectionViewCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    APostCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"APostCollectionViewCell" forIndexPath:indexPath];
    cell.delegate = self;
    if (!self.collectionViewPopular.hidden) {
