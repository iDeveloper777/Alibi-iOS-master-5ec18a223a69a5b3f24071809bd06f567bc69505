...
#import "AMyGuessesViewController.h"
#import "ALoadingCell.h"

@interface AMyGuessesViewController (){
    IBOutlet UITableView *postsTableView;
}

@end

@implementation AMyGuessesViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.title = @"MY GUESSES";
...
- (void)reloadData:(BOOL)reloadAll {
    ...
    [sharedConnect myGuessesForUserID:sharedConnect.currentUser.userID page:page pageSize:kDefaultPageSize onCompletion:^(NSMutableArray *posts, ServerResponse serverResponseCode) {
        loading = NO;
        self.posts = posts;
