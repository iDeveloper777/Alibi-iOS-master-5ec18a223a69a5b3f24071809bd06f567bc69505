...
@interface AEditProfileViewController : AViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate, MKMapViewDelegate, UIActionSheetDelegate> {
    BOOL imageReplaced;
    BOOL locatedUser;
}
