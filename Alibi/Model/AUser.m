...
- (id)initWithDictionary:(NSDictionary*)userWithInfo {
    ...
    if (self) {
        ...
        _pnOn = [self boolFromDictionary:userWithInfo forKey:@"pnOn"];
        ...
        _myGuessesCount = [self integerFromDictionary:userWithInfo forKey:@"myGuessesCount"];
...
- (void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeBool:self.pnOn forKey:@"pnOn"];
    ...
    [encoder encodeInt:self.myGuessesCount forKey:@"myGuessesCount"];
}
...
- (id)initWithCoder:(NSCoder *)decoder {
    ...
    if (self) {
        ...
        self.pnOn = [decoder decodeBoolForKey:@"pnOn"];
        ...
        self.myGuessesCount = [decoder decodeIntegerForKey:@"myGuessesCount"];
    }
    return self;
}
